...
import ProductForm from './VendorProductForm'; 
      ...
      >
        ...
        <div className={styles.mainVendorDashboard}>
            ...
            <header className={styles.productsHeader}>
                <h2>Products</h2>
                <button onClick={handleOpen}  type="button" className={styles.addProductBtn}><i className="fa fa-plus"></i> Add Products</button>
            </header>
