        ...
        <>
            <div className={styles.vendorNavContainer}>
                    ...
                    <div className={styles.vendorNavContainerBottom}>
                        <ul className={styles.vendorNav}>
                            <li className={styles.vendorNavItem}>
                                <button type="button" onClick={dashboardClicked} className={`${pathName === "/vendor/dashboard" ? styles.active : ""}`}>
                                    <div className={styles.textCarrier}><i className="fa fa-th-large"></i>Dashboard</div>
                                    <p></p>
                                </button>
                            </li>
                            <li className={styles.vendorNavItem}>
                                <button type="button" onClick={productsClicked} className={`${pathName === "/vendor/products" ? styles.active : ""}`}>
                            ...
                            <li className={styles.vendorNavItem}>
                                <button type="button" onClick={ordersClicked} className={`${pathName === "/vendor/orders" ? styles.active : ""}`}>
                                    <div className={styles.textCarrier}><i className="fa fa-clipboard"></i>Orders</div>
                                    <p>23</p>
                                </button>
                            </li>
                            <li className={styles.vendorNavItem}>
                                <button type="button" onClick={reportClicked} className={`${pathName === "/vendor/reports" ? styles.active : ""}`}>
                            ...
                            <li className={styles.vendorNavItem}>
                                <button type="button" onClick={settingsClicked} className={`${pathName === "/vendor/setting" ? styles.active : ""}`}>
                ...
                <div className={styles.vendorNavMainBottom}>
                    <button onClick={handleLogout}   ><i className="fa fa-right-from-bracket"></i> Logout</button>
                </div>
            </div>
        </>
    );
