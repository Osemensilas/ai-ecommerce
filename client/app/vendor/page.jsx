                        ...
                        <div className={styles.signinTop}>
                            <form onSubmit={(e) => e.preventDefault()} className={styles.signinForm}>
                                <div className={styles.formTop}>
                                    ...
                                    <h2>AhiaGlogal Vendor Login</h2>
                                    <p>Type your email address to log in or create an AhiaGlogal account</p>
                                </div>
                                    ...
                                    <div className={styles.formMiddle}>
                                        ...
                                        <div className={styles.linksContainer}>
                                            <div className={styles.formNewUser}>
                                                Are you new? <Link href={"/vendor/signup"}>Create Account</Link>
                                            </div>
                                            <div className={styles.forget}>
                                                <Link href="/vendor/forget-password">Forget Password?</Link>
                                            </div>
                                        </div>
                                    </div>
                                    <p>or</p>
